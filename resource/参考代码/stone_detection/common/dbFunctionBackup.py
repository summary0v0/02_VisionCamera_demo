...
################################################################################
## Form generated from reading UI file 'interfacePxlrhi.ui'
##
...
"")
        ...
        self.sorterCtrBox.setFont(font7)
        ...
        self.horizontalLayout_31.addWidget(self.sorterCtrBox)

        self.qrCtrBox = QGroupBox(self.hardwareCtrl)
        self.qrCtrBox.setObjectName(u"qrCtrBox")
        self.qrCtrBox.setFont(font7)
        self.verticalLayout_23 = QVBoxLayout(self.qrCtrBox)
        self.verticalLayout_23.setObjectName(u"verticalLayout_23")
        self.horizontalLayout_30 = QHBoxLayout()
        self.horizontalLayout_30.setObjectName(u"horizontalLayout_30")
        self.connect_qr_btn = QPushButton(self.qrCtrBox)
        self.connect_qr_btn.setObjectName(u"connect_qr_btn")

        self.horizontalLayout_30.addWidget(self.connect_qr_btn)

        self.disconnect_qr_btn = QPushButton(self.qrCtrBox)
        self.disconnect_qr_btn.setObjectName(u"disconnect_qr_btn")

        self.horizontalLayout_30.addWidget(self.disconnect_qr_btn)

        self.start_qr_monitor_btn = QPushButton(self.qrCtrBox)
        ...
        self.stop_qr_monitor = QPushButton(self.qrCtrBox)
        ...
        self.horizontalLayout_31.addWidget(self.qrCtrBox)
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.qrCtrBox.setTitle(QCoreApplication.translate("MainWindow", u"\u626b\u63cf\u67aa\u63a7\u5236", None))
        self.connect_qr_btn.setText(QCoreApplication.translate("MainWindow", u"\u8fde\u63a5\u626b\u63cf\u67aa", None))
        self.disconnect_qr_btn.setText(QCoreApplication.translate("MainWindow", u"\u8fde\u63a5\u626b\u63cf\u67aa", None))
